    ...
    implements IDetailsPageProvider
{
    ...
    private Map<Object, ExtensionDetailsPage> pageCache = new HashMap<Object, ExtensionDetailsPage>();
    ...
    public IDetailsPage getPage(Object key)
    {
        ...
        if (key instanceof Extension) {
            ...
            ExtensionDetailsPage page = new ExtensionDetailsPage(key, extension.getPoint());
