package org.seasar.kvasir.plust.maven.internal;
...
/**
 * Maven Console implementation for Kvasir/Sora
 */
public class KvasirConsole extends IOConsole implements MavenConsole, IPropertyChangeListener {
  ...
  public KvasirConsole(ImageDescriptor imageDescriptor) {
    // TODO extract constants
    super("Kvasir/Sora Console", imageDescriptor);
  ...
  protected void init() {
    ...
    display.asyncExec(new Runnable() {
      public void run() {
        JFaceResources.getFontRegistry().addListener(KvasirConsole.this);
